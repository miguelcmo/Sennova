...
INSERT INTO `auth_item` VALUES ('apprentice', 1, 'Learner with access to training materials', NULL, NULL, 1729789000, 1729789000);
INSERT INTO `auth_item` VALUES ('subscriber', 1, 'Basic access to the platform, with limited features', NULL, NULL, 1729789010, 1729789010);
...
CREATE TABLE `enrollment_message`  (
  ...
  CONSTRAINT `fk_message-user` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_message_enrollment` FOREIGN KEY (`enrollment_id`) REFERENCES `enrollment` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- Records of profile
-- ----------------------------
INSERT INTO `profile` VALUES (16, 1, NULL, NULL, DEFAULT, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, '2024-10-29 23:20:08', '2024-10-29 23:20:08');
...
-- ----------------------------
INSERT INTO `profile_info` VALUES (6, 16, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, '2024-10-29 23:20:08', '2024-10-29 23:20:08');
...
INSERT INTO `user` VALUES (11, 'advisor', 'n3gJx2eBE02hmlk5SWlVDY0kf_0uWShv', '$2y$13$DEVYQdTnmvucRJaJEQlMlOXjLGACC9K/gsk7cZ/gaGP0DVmVIifSG', NULL, 'advisor@serviser.com', 10, 1720680993, 1720680993, 'sgLnSkvuJYGuP14B4aISgBs8fmN824H_1729728555');
